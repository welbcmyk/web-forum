  ...
  return (
    <div onClick={props.onClickPost}>
      ...
      <div class="d-flex justify-content-between">
        ...
        <div>{props.showEdit ? <div onClick={props.onPostEdit} class="fa fa-pencil"></div> : ""}</div>
        <div>{props.showDelete ? <div onClick={props.onPostDelete} class="bi bi-trash"></div> : ""}</div>
      </div>
    </div>
  );
}
