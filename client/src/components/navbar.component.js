...
function Settings (props) {
  return (
    <NavDropdown title="Settings" id="settings-dropdown">
      ...
      <NavDropdown.Item onClick={props.deleteAccount}>Delete Account</NavDropdown.Item>
    </NavDropdown>
  );
}
...
function SearchBar(props) {
  return (
    <Form onSubmit={props.onSearch}  inline>
      <Form.Control value={props.value}type="text" placeholder="Search" onChange={props.onChangeSearchTerm} className="mr-sm-2"/>
        ...
        <Navbar bg="light" expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              {this.loggedIn() ? <Profil username={authenticationService.currentUserValue.username}/> : "" }
              {this.loggedIn() ? <Settings deleteAccount={this.handleShowDeletePopUp}/> : ""}
              {this.loggedIn() ? 
            ...
            <SearchBar value={this.state.searchTerm} onSearch={ this.enterSearch} onChangeSearchTerm={this.onChangeSearchTerm} />
          </Navbar.Collapse>
        </Navbar>
